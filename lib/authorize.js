...
function authorize(req, res, next) {
	...
	if (client.signatureRequired) {
		...
		var decodedOps = decodeURIComponent(ops);
		var decodedUrl = decodeURIComponent(url);
		var decodedUrlSingleSlash = decodeURIComponent(urlSingleSlash);
		var decodedUrlDoubleSlash = decodeURIComponent(urlDoubleSlash);

		var pathVersions = [
			ops + '/' + url,
			ops + '/' + urlSingleSlash,
			ops + '/' + urlDoubleSlash,
			decodedOps + '/' + decodedUrl,
			decodedOps + '/' + decodedUrlSingleSlash,
			decodedOps + '/' + decodedUrlDoubleSlash
		];
		var invalid = true;
